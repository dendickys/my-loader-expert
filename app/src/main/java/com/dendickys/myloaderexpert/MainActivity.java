...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContactAdapter.PermissionManager.isGranted(this, Manifest.permission.READ_CONTACTS)) {
            getSupportLoaderManager().initLoader(CONTACT_LOAD, null, this);
        } else {
            ContactAdapter.PermissionManager.check(this, Manifest.permission.READ_CONTACTS, CONTACT_REQUEST_CODE);
        }
    }
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        ...
        if (loader.getId() == CONTACT_LOAD) {
            ...
            if (ContactAdapter.PermissionManager.isGranted(this, Manifest.permission.CALL_PHONE)) {
                Intent dialIntent = new Intent(Intent.ACTION_CALL,
                        Uri.parse("tel:" + contactNumber));
                startActivity(dialIntent);
            } else {
                ContactAdapter.PermissionManager.check(this, Manifest.permission.CALL_PHONE, CALL_REQUEST_CODE);
            }
        }
    }
